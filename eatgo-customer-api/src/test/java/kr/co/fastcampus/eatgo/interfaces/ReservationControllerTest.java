...
class ReservationControllerTest {
    ...
    public void create() throws Exception {
        ...
        Reservation mockReservartion = Reservation.builder().id(12L).build();
        given(reservationService.addReservation(any(), any(), any(), any(), any(), any())).willReturn(mockReservartion);
